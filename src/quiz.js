...
// answer is correct
    ...
    document.getElementById(currentQuestion).style.backgroundColor = "rgba(12, 71, 15, 0.7)";
}
...
function answerIsWrong(){
    document.getElementById(currentQuestion).style.backgroundColor = "rgba(148, 5, 5, 0.7)";
}
